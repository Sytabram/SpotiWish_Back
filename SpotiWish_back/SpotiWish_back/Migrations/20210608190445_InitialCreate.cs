            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "INTEGER", nullable: false)
                        .Annotation("Sqlite:Autoincrement", true),
                    Name = table.Column<string>(type: "TEXT", maxLength: 20, nullable: true),
                    ProfilThumbnail = table.Column<byte[]>(type: "BLOB", nullable: true),
                    BackGroundThumbnail = table.Column<byte[]>(type: "BLOB", nullable: true),
                    TimeOfHeard = table.Column<int>(type: "INTEGER", nullable: false)
                },
                constraints: table =>
                {
