...
namespace SpotiWish_back.Controllers
{
    ...
    public class UsersController : ControllerBase
    {
        ...
        public UsersController(UserManager<User> userManager, IOptionsMonitor<JwtConfig> optionsMonitor, ILogger<UsersController> logger, IUsersService usersService, IMapper mapper)
        {
            _logger = logger;
